...
function runN_1TwoProportionTest(cl, casesA, totalA, casesB, totalB) {
  ...
  var critValue = Math.abs(NormSInv(cl));
  
 Logger.log(critValue);
/*
...
function checkInputsN_1(cl, casesA, totalA, casesB, totalB) {
  if ((cl<= 0 || cl>=100) || (casesA<= 0) || (casesB<= 0) || (totalA<= 0) || (totalB <= 0) || (totalA <= casesA) || (totalB <= casesB)) {
   return 0;
  }   
  else return 1;
}
